...
def interpret_results(results):
    ...
    If any queries failed, ensure that you do not provide any interpretation on their results. ONLY analyze successful queries that returned meaningful results.
    """
